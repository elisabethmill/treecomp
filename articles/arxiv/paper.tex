...
% Section 1.1 could use a little more narrative flow. You jump right in describing an article in the first sentence, but it would be helpful to provide more context. Is that article about sports? I think this section could be a little better organized into paragraphs with each paragraph representing one topic (e.g. interpreting machine learning algorithms, predicting player success in the draft, the concept of comps, etc.), with a sentence at the top of each paragraph explaining/introducing the topic. It would also be good to end this section with a paragraph explaining what your work accomplishes that hasn't been done before. 
