...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{cls_variable_importance.pdf}
    \includegraphics[width=0.5\linewidth]{rgr_variable_importance.pdf}
