...
\revision{
  The treecomp package, along with an R script for reproducing the results of this paper, is available at \url{https://github.com/elisabethmill/treecomp}.
}
